...
# v2.50.0 — Workflow execution telemetry panel strings
try:
    from translations_manual_29 import NEW_EN as _NEW_EN_29, NEW_ZH as _NEW_ZH_29
except Exception:
    _NEW_EN_29, _NEW_ZH_29 = {}, {}

# v2.51.0 — Quick Settings "Current parameters" read-only pane strings
try:
    from translations_manual_30 import NEW_EN as _NEW_EN_30, NEW_ZH as _NEW_ZH_30
except Exception:
    _NEW_EN_30, _NEW_ZH_30 = {}, {}

# v2.51.0 — Auto-Resume terminal-scope + Reliability category strings
try:
    from translations_manual_31 import NEW_EN as _NEW_EN_31, NEW_ZH as _NEW_ZH_31
except Exception:
...
# v2.54.0 — housekeeping panel UI strings (disk usage + prune)
try:
    from translations_manual_35 import NEW_EN as _NEW_EN_35, NEW_ZH as _NEW_ZH_35
except Exception:
...
try:
    from translations_manual_37 import NEW_EN as _NEW_EN_37, NEW_ZH as _NEW_ZH_37
except Exception:
    _NEW_EN_37, _NEW_ZH_37 = {}, {}

# v2.61.0 — Hot badge (I3) + IPC stream log panel (orchestrator)
try:
    from translations_manual_38 import NEW_EN as _NEW_EN_38, NEW_ZH as _NEW_ZH_38
except Exception:
...
try:
    from translations_manual_41 import NEW_EN as _NEW_EN_41, NEW_ZH as _NEW_ZH_41
except Exception:
...
try:
    from translations_manual_44 import NEW_EN as _NEW_EN_44, NEW_ZH as _NEW_ZH_44
except Exception:
    _NEW_EN_44, _NEW_ZH_44 = {}, {}

# v3.99.25 — sidebar chat mode toggle (helper ↔ orchestrator) + preset select.
try:
    from translations_manual_45 import NEW_EN as _NEW_EN_45, NEW_ZH as _NEW_ZH_45
except Exception:
    _NEW_EN_45, _NEW_ZH_45 = {}, {}
...
# v2.50.0 — Workflow execution telemetry panel
for _k, _v in _NEW_EN_29.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_29.items():
    MANUAL_ZH.setdefault(_k, _v)

# v2.51.0 — Quick Settings "Current parameters" read-only pane
for _k, _v in _NEW_EN_30.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_30.items():
    MANUAL_ZH.setdefault(_k, _v)

# v2.51.0 — Auto-Resume terminal-scope + Reliability category
...
# v2.57.0 — Ralph UI tab + Project Ralph card + workflow node inspector
for _k, _v in _NEW_EN_37.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_37.items():
    MANUAL_ZH.setdefault(_k, _v)

# v2.61.0 — Hot badge + IPC stream log panel
for _k, _v in _NEW_EN_38.items():
    MANUAL_EN.setdefault(_k, _v)
...
for _k, _v in _NEW_EN_44.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_44.items():
    MANUAL_ZH.setdefault(_k, _v)
for _k, _v in _NEW_EN_45.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_45.items():
    MANUAL_ZH.setdefault(_k, _v)
