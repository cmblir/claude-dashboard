"""AI 평가 · 기능 추천 · 설계 exports · 최적화 스코어 · 프로젝트 설정 프리뷰.

대시보드에서 Claude CLI 를 호출해 추천·평가를 수행하는 무거운 엔드포인트
들을 모아 둔 모듈. _template_* 는 CLAUDE.md / 에이전트 .md / skill / hooks
초안 생성을 담당.
"""
...
from .agents import _BUILTIN_AGENTS, _scan_plugin_agents
from .claude_md import get_settings
from .config import (
    AGENTS_DIR, CLAUDE_HOME, CLAUDE_JSON, CLAUDE_MD,
    COMMANDS_DIR, PLUGINS_DIR, PROJECTS_DIR, SCORE_MIN_TOOLS,
    SESSIONS_DIR, SETTINGS_JSON, SKILLS_DIR,
    _env_path,
)
from .db import _db, _db_init
from .device import _detect_device_info
from .hooks import _scan_plugin_hooks
from .logger import log
from .plugins import list_plugins_api
from .projects import (
    AGENT_ROLE_CATALOG, _resolve_cwd_input,
    _scan_repo_local_claude,
)
from .agents import list_agents
from .commands import list_commands
from .hooks import get_hooks
from .mcp import list_connectors
from .skills import _scan_plugin_skills, list_skills
from .utils import (
    _parse_frontmatter, _safe_read, _safe_write, _strip_frontmatter,
)
