...
[![Version](https://img.shields.io/badge/version-v2.34.2-green.svg)](./CHANGELOG.md)
...
| 버전 | 요점 |
|---|---|
| **v2.34.2** | 🧑‍✈️ **크루 위저드** — Zapier 식 4-스텝 폼만 채우면 기획자 + 페르소나 N명 + Slack 어드민 게이트 + Obsidian 기록까지 자동 생성. 신규 노드 `slack_approval` (Slack Web API), `obsidian_log`. |
